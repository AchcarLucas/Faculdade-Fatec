       ...
       *> 1) Por que o programa anterior é um programa que não devemos 
       *> fazer. 
       *> R) O código está ilegível devida a indentação e não possui 
       *> divisão de procedimento, tendo separação mas sendo inutil 
       *> (não sendo chamado em perform)
       *> 2) Faça o mesmo programa do jeito “mais correto” de fazer.
       *> R) To fazendo mestre.